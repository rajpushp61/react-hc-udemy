...
function App() {
  ...
  <div className='w-full h-screen flex flex-wrap
    justify-center items-center bg-cover bg-no bg-repeat'
    style={{backgroundImage: `url(https://images.pexels.com/photos/4386442/pexels-photo-4386442.jpeg?auto=compress&cs=tinysrgb&w=400)`}}>
